...
public class TestPlip {
    ...
    public void testReplicate() {
        double delta = 0.001;
        Plip p = new Plip(2);
        Plip pJunior = p.replicate();
        assertNotEquals(p, pJunior);
        assertEquals(1, p.energy(), delta);
    ...
    public void testChoose() {
        ...
        // Any Cloruses, MOVE with 50% probability, towards an empty direction chosen at random.
