...
public class IntListTest {
    ...
    public void testReverse(){
        ...
        assertEquals(IntList.reverse(C),expC);

        IntList D = IntList.of(1,2);
        IntList expD = IntList.of(2,1);
        assertEquals(IntList.reverse(D),expD);

        IntList E = IntList.of(1,2,3,4);
        IntList expE = IntList.of(4,3,2,1);
        assertEquals(IntList.reverse(E),expE);
